...
import server2.SocksServerConnectHandler
import server2.SocksServerUtils
...
class SocksServerHandler private constructor() : SimpleChannelInboundHandler<SocksMessage>() {
    ...
    public override fun channelRead0(ctx: ChannelHandlerContext, socksRequest: SocksMessage) {
        println("SocksServer : SocksServerHandler channelRead0 : ${socksRequest}")
    ...
    companion object {
        val INSTANCE: SocksServerHandler = SocksServerHandler()
    }
}